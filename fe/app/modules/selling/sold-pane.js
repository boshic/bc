...
import commonPaneCtrlr from '../../controllers/common-pane-ctrlr';
    ...
    let soldPaneCtrlr = ($s, filterFactory, paneFactory, printFactory, modalFactory) => {

        return commonPaneCtrlr($s, filterFactory, paneFactory, printFactory, modalFactory, 'soldPaneConfig');
        ...
        .directive( "soldPane", () => {
            return {
                ...
                controller: ($scope, filterFactory, paneFactory, printFactory, modalFactory) => {
                    return soldPaneCtrlr($scope, filterFactory, paneFactory, printFactory, modalFactory);
                },
                link: (scope) => {
                    scope.resetFilter();
                }
